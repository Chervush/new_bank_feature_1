...
# Проверка функции mask_account_card с использованием номеров счетов и карт,
# с пробелами и без, со строчным написанием visa, mastercard
@pytest.mark.parametrize(
    "acc_card_number, expected",
    [
...
# Проверка функции get_date с использованием неправильного формата даты

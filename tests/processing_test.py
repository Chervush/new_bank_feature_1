...
# проверка по состоянию EXECUTED
...
# проверка по состоянию CANCELED
...
# проверка по не указанному состоянию
...
# проверка сортировки по состояниям с использованием параметризации
@pytest.mark.parametrize(
    "list_of_dates, state, expected",
    [
        (
            list_of_dates,
            "EXECUTED",
...
# переменные для проверки следующих тестов
...
# проверка, что список корректно сортируется и по убыванию и по возрастанию
@pytest.mark.parametrize(
    "list_of_dates, is_reversed, expected",
    [
...
# проверка, что список остается неизменным при одинаковых датах
...
# проверка, что список корректно сортируется при разных форматах даты, в обоих направлениях
